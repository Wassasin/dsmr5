...
impl<'a> OBIS<'a> {
    pub fn parse(line: &'a str) -> Result<OBIS<'a>> {
        ...
        match reference {
            ...
            "1-0:1.8.1" => Ok(OBIS::MeterReadingToTariff1(UFixedDouble::parse(body, 9, 3)?)),
            "1-0:1.8.2" => Ok(OBIS::MeterReadingToTariff2(UFixedDouble::parse(body, 9, 3)?)),
            "1-0:2.8.1" => Ok(OBIS::MeterReadingByTariff1(UFixedDouble::parse(body, 9, 3)?)),
            "1-0:2.8.2" => Ok(OBIS::MeterReadingByTariff2(UFixedDouble::parse(body, 9, 3)?)),
            ...
            "1-0:32.7.0" => Ok(OBIS::InstantaneousVoltageL1(UFixedDouble::parse(body, 4, 1)?)),
            "1-0:52.7.0" => Ok(OBIS::InstantaneousVoltageL2(UFixedDouble::parse(body, 4, 1)?)),
            "1-0:72.7.0" => Ok(OBIS::InstantaneousVoltageL3(UFixedDouble::parse(body, 4, 1)?)),
            ...
            "1-0:21.7.0" => Ok(OBIS::InstantaneousActivePowerPlusL1(UFixedDouble::parse(body, 5, 3)?)),
            "1-0:41.7.0" => Ok(OBIS::InstantaneousActivePowerPlusL2(UFixedDouble::parse(body, 5, 3)?)),
            "1-0:61.7.0" => Ok(OBIS::InstantaneousActivePowerPlusL3(UFixedDouble::parse(body, 5, 3)?)),
            "1-0:22.7.0" => Ok(OBIS::InstantaneousActivePowerNegL1(UFixedDouble::parse(body, 5, 3)?)),
            "1-0:42.7.0" => Ok(OBIS::InstantaneousActivePowerNegL2(UFixedDouble::parse(body, 5, 3)?)),
            "1-0:62.7.0" => Ok(OBIS::InstantaneousActivePowerNegL3(UFixedDouble::parse(body, 5, 3)?)),
            _ => {
                ...
                match subreference {
                    "24.1.0" => Ok(OBIS::SlaveDeviceType(channel, UFixedInteger::parse(body, 3)?)),
